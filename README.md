...
<p align="center">
  <a href="https://www.instagram.com/larizvbg/" target="_blank">
    <img src="https://www.pngmart.com/files/23/Instagram-Logo-Black-And-White-PNG-Pic.png" height="20" width="20">
  </a>
  &nbsp;
...
## 👩‍🎓 About Me
- Studying Computer Science at **UFPB**
- I mainly use: ```.c```, ```.cpp```, ```.tsx```, ```.ipynb```, ```.py```
- Interested in:
  - Web Development  
